         ...
         <div className="flex flex-col md:flex-row text-sm mb-20">
            <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
               ...
               <p className="text-gray-600">
                  We meticulously select and vet each product, ensuring it meets
            ...
            <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
               <b>Convenience:</b>
               <p className="text-gray-600">
                  With our user-friendly interface, you can shop from anywhere,
                  at any time, from the comfort of your own home.
               </p>
            </div>
            <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
               <b>Exceptional Cutomer Service:</b>
               <p className="text-gray-600">
                  Our team of dedicated professionals is always available to
                  assist you, ensuring a smooth shopping experience.
               </p>
            </div>
         </div>
